...
while True:
    ...
    user_text = " ".join(
        seg.text
        for seg in transcriber.transcribe_from_file("voice_record.wav")[0])
    print(f">>>{user_text}\n<<< ", end="", flush=True)
